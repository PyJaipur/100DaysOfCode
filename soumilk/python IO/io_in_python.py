...
##Copying Files:
#with open("test.txt", "r") as rf:                             # from test.txt we are copying data in test_copy
	#with open("test_copy.txt", "w") as wf:                # If not already present then it will make a new file name test_copy and start to write from test.txt
		#for line in rf:
			#wf.write(line)
